...
# Load the dataset
file_path = 'Housing.csv'  # Ensure the file path is correct
...
# Load the dataset
file_path = 'path/to/laptop_cleaned2.csv'
data = pd.read_csv(file_path)
...
with open('sales_prediction_model.py', 'w') as f:
    f.write(model_code)

print("\nModel code saved to 'sales_prediction_model.py'.")
